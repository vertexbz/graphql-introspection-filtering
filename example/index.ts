...
import createSchemaCommon from '../tests/integration/_mocks_/schemas/common-cases';
...
use(app, '/graphql/common-cases/guest', createSchemaCommon(testUser, testMutation, testSubscription, ['GUEST']));
use(app, '/graphql/common-cases/user', createSchemaCommon(testUser, testMutation, testSubscription, ['GUEST', 'USER']));
use(app, '/graphql/common-cases/admin', createSchemaCommon(testUser, testMutation, testSubscription, ['GUEST', 'USER', 'ADMIN']));
